...
function normalizeLabelData(value: unknown): LabelData {
  ...
  return {
    ...
    boardSku: nullableText(data.boardSku ?? data.board_sku),
    gpuSku: nullableText(data.gpuSku ?? data.gpu_sku),
    boardArchitecture: nullableText(data.boardArchitecture ?? data.board_architecture),
